...
## CORES          = bluemsx fake-08 fbalpha2012 fceumm fmsx gambatte gme gpsp mame2000 mame2003_plus mednafen_ngp mednafen_pce_fast mednafen_wswan pcsx_rearmed picodrive pokemini quicknes smsplus-gx snes9x2002
## ifneq ($(platform), trimui)
## 	CORES      := $(CORES) chimerasnes dosbox-pure ecwolf mednafen_lynx prboom scummvm snes9x2005 snes9x2005_plus snes9x2010 stella2014 tyrquake vitaquake2
## endif
